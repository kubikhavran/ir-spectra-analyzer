...
class BatchPDFExportDialog(QDialog):
    ...
    def _on_export(self) -> None:
        ...
        if isinstance(self._exporter, BatchPDFExporter):
    ...
    def _start_background_export(
        ...
        *,
        ...
        """Run batch PDF export in a worker thread for the default exporter path."""
        from ui.workers.batch_pdf_export_worker import BatchPDFExportWorker  # noqa: PLC0415
    ...
    def _set_export_busy(self, busy: bool) -> None:
        ...
        if busy:
            self._summary_label.setText("Exporting PDF reports…")
